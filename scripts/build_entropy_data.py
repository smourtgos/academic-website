...
# --------------------------------------------------------------------------- assemble
DATA = dict(
    meta=dict(yearMin=YMIN, yearMax=YMAX, source="criminogenic entropy analysis (1970-2023)",
...
with open(OUT_JS, "w") as f:
    f.write("// AUTO-GENERATED by scripts/build_entropy_data.py — do not edit by hand. Source: %s\n" % DATA["meta"]["source"])
