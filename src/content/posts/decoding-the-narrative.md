...
date: 2023-05-01
summary: "Using structural topic modeling on a corpus of 29,035 news headlines spanning 1990-2021, this analysis identifies eight latent media narratives about police use of force and examines their association with public opinion."
tags: ["topic modeling", "text analysis", "police", "bayesian"]
featured: false
---
...
What do we know about media coverage of police use-of-force and its effect on public opinion? While it is axiomatic to say that news media influences public opinion, surprisingly little work has been done to understand how the news media frames the narrative(s) surrounding police use-of-force over time. This is not to say that no one has studied media effects on public opinion surrounding police use-of-force. Lawrence (2000)[^1] and Fridkin and colleagues (2017)[^2] are just a couple of works I have found immensely influential. However, these works typically examine media surrounding a specific controversial use-of-force event. Or, if they examine news media coverage over a longer period of time, the sample size is relatively small. This 'small-n' problem is a function of the constraints that conventional qualitative work places on researchers, namely time.
...
Due to the computational demand for such a large corpus, I restricted the corpus to the following newspaper publications: USA Today, New York Times, Washington Post, St. Louis Post, Atlanta Journal-Constitution, and Wall Street Journal. I chose these publications guided by Enns' (2016)[^3] work. Enns explains that using newspapers, while not perfect, is often the best option when working with news time-series data.
...
![Distribution of words per headline across the corpus of 29,035 headlines](/images/posts/decoding-the-narrative/unnamed-chunk-1-1.png)
...
![Twenty most frequent terms in the headline corpus](/images/posts/decoding-the-narrative/unnamed-chunk-2-1.png)
...
## What do the News Media's Narratives Look Like Across Time?
...
![Histogram distributions of the most strongly associated topic per document across time, faceted by topic](/images/posts/decoding-the-narrative/unnamed-chunk-3-1.png)
...
![Loess smoothed estimates of topic proportions across time](/images/posts/decoding-the-narrative/unnamed-chunk-4-1.png)
...
![Disaggregated GSS measures alongside the validated public opinion measure of disapproval of legally reasonable police use of force](/images/posts/decoding-the-narrative/unnamed-chunk-5-1.png)
...
![Coefficient plot showing media narrative effects on disapproval of legally reasonable police use of force, with 95% credible intervals](/images/posts/decoding-the-narrative/unnamed-chunk-6-1.png)
...
[^1]: Lawrence, R. G. (2000). The politics of force: Media and the construction of police brutality. University of California Press.
[^2]: Race and Police Brutality: The Importance of Media Framing. International Journal of Communication, 11, 3394-3414.
[^3]: Enns, P. K. (2016). Incarceration nation. Cambridge University Press.
[^4]: Assessing public perceptions of police use-of-force: Legal reasonableness and community standards. Justice Quarterly, 37(5), 869-899. https://doi.org/10.1080/07418825.2019.1679864
