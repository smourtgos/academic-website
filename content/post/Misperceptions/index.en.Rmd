...
subtitle: 'A nationally representative survey reveals just how wrong Americans are—and where they’re most misinformed.'
summary: 'New national survey data shows geographic variation in how Americans perceive police use of force, and that public estimates are vastly inflated compared to reality.'
authors: ['Scott M. Mourtgos']
lastmod: '2025-07-25T08:00:00-04:00'
featured: yes
image:
  caption: 'Choropleth maps of misperception scores by state'
  focal_point: 'center'
  preview_only: no
projects: []
---
...
### What Do Americans Really Believe About Police Use of Forcec?
...
Each respondent also provided their ZIP code, which allowed me to map responses to both **national** and **state-level** benchmarks on actual fatal police shootings (based on a decade’s worth of Washington Post data) as well as national estimates of use-of-force frequency from BJS data.[^1]
...
These findings raise important questions for future research. While misperceptions about police use of force are widespread and highly consistent across states, we still know little about **what shapes these beliefs**. Future work should explore:
